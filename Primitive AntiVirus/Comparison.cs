...
namespace Primitive_AntiVirus
{
    public static class Comparison
    {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (memoryUsage > 25.0f || cpuUsage > 25.0f)
                    {
                        ...
                        Console.WriteLine($"Process {process.ProcessName} has high resource usage. ");
                        Console.WriteLine($"Process originated from :");
                        TrackingAndIso.StartTracking(process);
                        Console.WriteLine($"Do you want to add it to the BlackList? (yes/no)");
        ...
        public static void UpdateList()
        {
            ...
            catch { Console.WriteLine("Unable to find process"); }
        }
        public static void AddTxtToBL() {
            ...
            try
            {
                ...
                Console.WriteLine("\n\tBlackListed processes loaded successfully");
            }
            catch (IOException e)
            {
